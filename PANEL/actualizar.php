          ...
          <?php $resultado = mysqli_query($conexion, $prestamos);
            while($row=mysqli_fetch_assoc($resultado)) { ?>
              <tr>
                ...
                <td><input type="text" value="<?php echo $row['dni']; ?>" name="dni" class="input"></td>
                <td><input type="text" value="<?php echo $row['nombre']; ?>" name="nombre" class="input"></td>
                <td><input type="text" value="<?php echo $row['apellidos']; ?>" name="apellidos" class="input"></td>
                <td><input type="text" value="<?php echo $row['tlf']; ?>" name="telefono" class="input"></td>
                <td><input type="email" value="<?php echo $row['email']; ?>" name="email" class="input"></td>
                <td><input type="text" value="<?php echo $row['titulo_libro']; ?>" name="titulo_libro" class="input"></td>
                <td><input type="date" value="<?php echo $row['fecha_prestamo']; ?>" name="fecha_prestamo" class="input"></td>
                <td><input type="date" value="<?php echo $row['fecha_devolucion']; ?>" name="fecha_devolucion" class="input"></td>
                <td><input type="checkbox" value="<?php echo $row['penalizacion']; ?>" name="penalizacion" class="input"></td>
                <td><input type="submit" value="ACTUALIZAR" name="actualizar" class="actualizar" ></td>              
                </tr>
